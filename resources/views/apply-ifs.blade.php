        ...
        <div class="container">
            <div class="row h-100">
                <div class="text-center col-md-8 ml-auto mr-auto">
                    <img class="d-block mx-auto mb-4" src="/img/ifs-logo2.png" alt="" width="96"
                        height="96" style="margin-top:50px">
                            ...
                            <ul class="list-group mb-3">
                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div>
                                        ...
                                        <input type="text" class="from-control" value="{{ $id }}"
                                            id="drive" name="drive" readonly>
...
-->
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div>
                                        ...
                                        <input type="number" class="form-control" id="expsalary" name="expsalary"
                                            required min="5000">
                                        <div class="invalid-feedback">
                                ...
                                @if ($job->drive_for == 'Teaching Staff')
                                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="subject[]"
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="subject[]" value="urdu"
                                                    id="urdu" class="custom-control-input">
                                                <label class="custom-control-label" for="urdu">Urdu</label>
                                            </div>
                                            <!--
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="subject[]" value="sindhi" id="sindhi"
                                                class="custom-control-input">
                                            <label class="custom-control-label" for="sindhi">Sindhi</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="subject[]" value="accounts" id="accounts"
                                                class="custom-control-input">
                                            <label class="custom-control-label" for="accounts">Principles of Accounting</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="subject[]" value="business-studies" id="business-studies"
                                                class="custom-control-input">
                                            <label class="custom-control-label" for="business-studies">Business Studies</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="subject[]" value="pakistan-studies" id="pakistan-studies"
                                                class="custom-control-input">
                                            <label class="custom-control-label" for="pakistan-studies">Pakistan Studies</label>
                                        </div>
                                        
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="subject[]"
                                                value="NA" id="nasubject">
...
-->
                                    ...
                                    @if ($grades)
                                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                                            <div class="checkbox-group grade">
                                                <label for="expsalary">Preferred Grade</label>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="Preschool" id="preschool">
                                                    <label class="custom-control-label"
                                                        for="preschool">Preschool<br />(Pre-Nursery to
                                                        Kindergarten)</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="Elementary" id="elementary">
                                                    <label class="custom-control-label"
                                                        for="elementary">Elementary<br />(G01 to
                                                        G05)</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="Middle" id="middle">
                                                    <label class="custom-control-label" for="middle">Middle<br>(G06
                                                        to
                                                        G08)</label>
                                                </div>
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="O Levels" id="olevel">
                                                    <label class="custom-control-label" for="olevel">O
                                                        Levels</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="A Levels" id="alevels">
                                                    <label class="custom-control-label" for="alevels">A
                                                        Levels</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="grade[]" value="NA" id="na">
                                                    <label class="custom-control-label" for="na">Not
                                                        Applicable</label>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            @endif
                        @elseif($job->drive_for == 'Administrative Staff')
                            <!--
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div>
                                        ...
                                        <input type="email" class="form-control" id="retypeemail" placeholder=""
                                            value="" name="retypeemail" required onpaste="return false;">
                                        <div class="invalid-feedback">
                                            Valid e-mail address is required.
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item d-flex justify-content-between bg-light">
                                    <div>
                                        ...
                                        <input type="file" class="form-control-file" id="documents"
                                            name="documents[]" accept="image/*" multiple required>
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-md-8 order-md-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="mstatus" name="mstatus"
                                        required>
                                        <option value="">Choose...</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="dabled" name="dabled"
                                        required>
                                        <option value="">Choose...</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="specify" name="specify"
                                        pattern="[a-zA-Z]*( [a-zA-Z]*)*" placeholder="" value="NA" required>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="edu-add-more">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-3">
                                        ...
                                        <input type="month" class="form-control" id="passingyear"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="month" class="form-control" id="workingsince"
                                        name="workingsince">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="ntexp">Total Non-Teaching Experience</label><select
                                        class="custom-select d-block w-100" id="ntexp" name="ntexp">
                                        <option value="">Choose...</option>
                                        <option value="No Experience"> No Experience</option>
                                        <option value="Less than 1 year"> Less than 1 year </option>
                                        <option value="1-2 years"> 1-2 years </option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100" id="employment" name="employment"
                                        required>
                                        <option value="">Choose...</option>
        ...
        @if ($grades)
            <script>
                function checkForm(form) {
                    if ($('div.checkbox-group.subject :checkbox:checked').length < 1 || $(
                            'div.checkbox-group.grade :checkbox:checked').length < 1) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Select Valid Choice',
                            text: 'Please select atleast one choice in Grade/Subject',
                            footer: 'Isra Foundation School?'
                        })
                ...
                function checkForm(form) {
                    if ($('div.checkbox-group.subject :checkbox:checked').length < 1) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Select Valid Choice',
                            text: 'Please select atleast one choice in Subject',
                            footer: 'Isra Foundation School?'
                        })
                        event.preventDefault()
                        event.stopPropagation()
